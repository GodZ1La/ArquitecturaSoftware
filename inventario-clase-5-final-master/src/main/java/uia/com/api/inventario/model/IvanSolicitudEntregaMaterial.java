...
@Node("EntregaMaterial")
public class IvanSolicitudEntregaMaterial {
    @Id
    private String id;
    @Property("name")
    private String name;
    ...
    public IvanSolicitudEntregaMaterial(String id, String name, String descripcion, String estatus, String clase, String fechaIngreso, String nameLote, String idItem,
    ...
    public IvanSolicitudEntregaMaterial() {
    }
